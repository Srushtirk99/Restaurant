  ...
  <div>
    <div class="home-main">
      <div class="content">
        ...
        <h3>Original taste from CRAVE 😋</h3>
        <p>
          Introducing Crave—your ultimate dining destination! Located in
          Hubballi Urban, Crave offers a fusion of traditional and contemporary
          cuisine. We've revolutionized dining with our innovative online
          system, allowing you to order your favorite dishes or reserve a table
          with just a few clicks. Whether you dine in or order online, Crave
          promises a delightful culinary experience that satisfies every
          craving. Experience food like never before at Crave!
        </p>
      ...
      <div class="image">
        <img
          src="https://img.freepik.com/free-photo/traditional-mexican-tacos-with-meat-vegetables-isolated-white-background_123827-19927.jpg?ga=GA1.1.229800969.1733806844&semt=ais_hybrid"
          alt=""
          class="home-img"
        />
    ...
    <div class="home-about">
      <div class="image">
        <img
          src="https://photos.smugmug.com/Articles-photos/Article-Photos/n-LTHNmq/2023-article-photos/i-XKZ6rrq/0/CmTRrM5XBjj8QKC95S6fnL4qLxb88KmjPRQjPc9j7/L/ai-mexican-food%20%281%29-L.jpg"
          alt=""
        />
      </div>
      <div class="content">
        ...
        <p>
          Discover the vibrant flavors of Mexico at Crave, your go-to spot for
          authentic Mexican cuisine in Hubballi Urban. Our chefs bring the rich,
          bold tastes of traditional Mexican dishes right to your table,
          ensuring every bite is a fiesta for your taste buds. Whether you're
          dining in or enjoying our easy-to-use online system, Crave guarantees
          a delightful experience. Choose Crave for a true taste of Mexico,
          where every meal is crafted with passion and authenticity. 🌮🥑🔥
        </p>
